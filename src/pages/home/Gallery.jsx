...
const Gallery = () => {
  return (
    <div className=" bg-purple-100">
      <div className=" max-w-[1440px] mx-auto grid md:grid-cols-4 md:grid-rows-3 gap-2 py-2">
        {/* Image 1 */}
        <div className="hidden md:block  h-52 overflow-hidden w-full col-span-2 relative group">
        ...
        {/* Image */}
        <div className="hidden md:block h-52 overflow-hidden w-full relative group col-span-2">
